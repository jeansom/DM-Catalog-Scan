...
import calc_llflux_noscan as clf
import argparse
...
for ebin in range(40):
    cli = clf.calc_llflux_noscan(J_map_arr=J_map_arr,tag=tag,band_mask=band_mask_val,external_data=fake_data,calc_flux_array=True,flux_array_ebin=ebin,bin_min=-8,bin_max=1,nbins=50)
