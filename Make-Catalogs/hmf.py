...
class HaloMassFunction:
    ...
    """
    def __init__(self, redshift, omega_m=0.27, omega_b=0.045, omega_l=0.73, hubble=0.7, ns=0.95, sigma8=0.8, mass_function=None, log_mass_lim=(-6, 17) ):
        #Sigma tables
...
class Overdensities:
    ...
    def __init__(self,redshift,omega_m=0.27, omega_b=0.045,omega_l=0.73,hubble=0.7, ns=0.95,sigma8=0.8,num_sigma_bins=50,log_mass_lim=(-6, 17)):
