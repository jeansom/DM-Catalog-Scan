...
#f_global.add_ps_model(comp='ps_model') # Old way of adding for comparison
...
for n in range(nsim):
    ...
    np.save(work_dir + 'FakeMaps/MC_'+str(outstring)+'_nodm_nops_v'+str(n)+'.npy',nodm_out)
