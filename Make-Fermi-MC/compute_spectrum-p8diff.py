...
norm_file_path='/tigress/nrodd/2mass2furious/MakeMC/P8UCVA_norm_dp8'
spect_file_path='/tigress/nrodd/2mass2furious/MakeMC/P8UCVA_spec_dp8'
...
f_total.add_diffuse_newstyle(comp = 'p8',eventclass = eventclass, eventtype = eventtype) #diffuse
...
def setup_b_instance(ebin_min):
    ...
    ##############
    temp_key_list = ['ps_model','p8','bubs','iso']
