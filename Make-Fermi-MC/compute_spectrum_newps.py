# Compute the spectrum using our new ps_model
...
norm_file_path='/tigress/nrodd/2mass2furious/MakeMC/P8UCVA_norm_newps'
spect_file_path='/tigress/nrodd/2mass2furious/MakeMC/P8UCVA_spec_newps'
...
f_total.add_iso()  #iso
# Add ps template by hand!
ps_temp = np.load('/tigress/nrodd/2mass2furious/PSmaps/ps_map.npy')
f_total.add_template_by_hand(comp='ps_model',template=ps_temp)
#f_total.add_ps_model() # Old way of adding for comparison
