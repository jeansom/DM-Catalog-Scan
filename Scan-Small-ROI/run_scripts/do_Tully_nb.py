...
'''
        ...
        batch3 = '''
echo "#!/bin/bash \necho i = \$1 \npython scan_interface.py --catalog_file $catalog_file --boost 0 --diff p8 --start_idx $start_idx --perform_scan 0 --imc ''' + str(mci) + ''' --iobj \$1 --load_dir Tully --save_dir Tully --float_ps_together 0 --Asimov 0 --floatDM 1" > ./run_scripts/conf/run-Data-indiv-floatDM-'''+str(it)+'''-v'''+str(mci)+'''.sh
