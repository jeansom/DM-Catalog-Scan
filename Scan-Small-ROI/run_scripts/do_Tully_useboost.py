...
'''
        ...
        batch3 = '''
echo "#!/bin/bash \necho i = \$1 \npython scan_interface.py --catalog_file $catalog_file --diff p8 --start_idx $start_idx --perform_scan 0 --imc ''' + str(mci) + ''' --use_boost 1 --iobj \$1 --save_dir Tully_useboost --float_ps_together 0 --Asimov 0 --floatDM 1 --restrict_pp 1 --emin 4 --emax 30" > ./run_scripts/conf/run-Data-ecut4.g-indiv-useboost-'''+str(it)+'''-v'''+str(mci)+'''.sh
