...
'''
        ...
        batch3 = '''
echo "#!/bin/bash \necho i = \$1 \npython scan_interface.py --catalog_file $catalog_file --start_idx $start_idx --randlocs 1 --perform_scan 1 --imc -1 --iobj \$1 --save_dir Tully_randlocs''' + str(mci) + ''' --float_ps_together 0 --Asimov 0 --floatDM 1" > run_scripts/conf/run-Tully'''+str(it)+'''-v'''+str(mci)+str(loc)+'''.sh
