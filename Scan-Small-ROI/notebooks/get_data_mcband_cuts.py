...
plot_data_skylocs = LimitPlot(data_dir='/tigress/nrodd/DM-Catalog-Scan/Scan-Small-ROI/data/Tully_skylocs_no0p5mask_emin4_emax30/',
                        elephant=False, 
                        nmc=200,
                        bcut=20,
                        nonoverlap=True,
...
np.save("data_skylocs_ary_ecut4_emax30_200",data_skylocs_ary)
np.save("maxTS_skylocs_ary_ecut4_emax30_200",maxTS_skylocs_ary)
