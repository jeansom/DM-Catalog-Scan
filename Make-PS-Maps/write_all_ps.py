...
for E in range(40):
    data = mlp.load_data(E,eventclass=5,eventtype=0,fermi_data_dir=fermi_data_dir,maps_dir=maps_dir,nside=nside,mask_type=mask_type)
...
for psi in range(0,3034):
    ...
    np.save('/tigress/bsafdi/github/NPTF-working/NPTF-ID-Catalog/data/ps_data/ps_temp_'+str(nside)+'_5_0_'+str(psi)+'.npy',ps_out)
